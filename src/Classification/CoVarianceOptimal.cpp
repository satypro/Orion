...
CoVarianceOptimal::CoVarianceOptimal()
{
}
...
Output Params		:
*****************************************************************************************/
void CoVarianceOptimal::setInputCloud(pcl::PointCloud<pcl::PointXYZ>::Ptr cloud)
{
	_inCloud = cloud;
}
/*****************************************************************************************
...
Output Params		:
*****************************************************************************************/
void CoVarianceOptimal::setOctree(OctreeXYZ<PointT, LeafContainerT, BranchContainerT > * octree)
{
	_octree = octree;
}
/*****************************************************************************************
...
void CoVarianceOptimal::setParams(float rmin, float rmax, float rmaxpt, float epsi, float scale)
{
	_rmin = rmin;
	_rmax = rmax;
	_rmaxpt = rmaxpt;
...
Output Params		:
*****************************************************************************************/
bool CoVarianceOptimal::setAccumzero()
{
...
Output Params		:
*****************************************************************************************/
bool CoVarianceOptimal::voteAccum(float radius, vector<probfeatnode> &probfeatVal)
{
...
*****************************************************************************************/
void CoVarianceOptimal::prob_measure(vector <probfeatnode> *probval, vector<tensorType> *aggregated_tensor, vector<int> optimalScale)
{
...
*****************************************************************************************/
bool CoVarianceOptimal::probMeasure(vector<probfeatnode>&probfeatVal)
{
...
Output Params		:
*****************************************************************************************/
void CoVarianceOptimal::writeGlyphVars(float radius)
{
...
Output Params		:
*****************************************************************************************/
void CoVarianceOptimal::computeSaliencyVals(glyphVars &glyphtemp, int idx)
{
...
Output Params		:
*****************************************************************************************/
void CoVarianceOptimal::glyphAnalysis(glyphVars &glyphtemp)
{
...
Output Params		:
*****************************************************************************************/
bool CoVarianceOptimal::eigendecomposition(glyphVars &glyphtemp, size_t idx)
{
